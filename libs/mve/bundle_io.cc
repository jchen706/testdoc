...
{
       std::cout << "in load mve bundle " << std::endl;
    ...
    std::vector<NVMCameraInfo>* camera_info)
{
    ...
    std::cout << "NVM: Loading file..." << filename << std::endl;
    ...
    std::cout << "return from bundle in bundle_io.cc" <<std::endl;
